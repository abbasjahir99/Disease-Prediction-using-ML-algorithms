...
def copd(request):
    if request.method == 'POST':
        ...
        body = 'The patient was affected by {0}'.format(copdpred)
        try:
...
#type(smtpObj) 
        smtpObj.ehlo()
        smtpObj.starttls()
        smtpObj.login('techcitiforyou@outlook.com', "techcititech@1234") 
        smtpObj.sendmail('techcitiforyou@outlook.com', email, body) # Or recipient@outlook
        ...
        sender_email = "techcitiforyou@outlook.com"
        receiver_email = email
        password = 'techcititech@1234'
...
def diabetes(request):
    if request.method == 'POST':
        ...
        outlook.send(
            receivers=email,
            subject="Prediction for Diabetes",
            #text="Hi, this is an example."
        text = """\
